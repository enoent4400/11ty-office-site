module.exports = {
	...
	slogan: {
		'sr': 'Tradicija. Efikasnost. Posvećenost.',
		'en': 'Tradition. Efficiency. Dedication.'
	},
	headerLinkHome: {
		'en': 'Home',
		'sr': 'Početna'
	...
	headerLinkAboutItem1: {
		'en': 'About Us',
		'sr': 'O Nama'
	},
	headerLinkAboutItem2: {
		'en': 'The Team',
		'sr': 'Naš Tim'
	},
	headerLinkServices: {
	...
	hero: {
		provenResults: {
			title: {
				'en': 'Proven Results',
				'sr': 'Dokazani rezultati',
			},
			content: {
				'en': 'Our Law Office has provided quality, trusted legal representation to individuals and companies for the past few decades.',
				'sr': 'Naša advokatska kancelarija je u poslednjih nekoliko decenija obezbedila kvalitetno i poverljivo pravno zastupanje kako pojedincima tako i kompanijama.'
			}
		},
		experienceWhenItMatters: {
			title: {
				'en': 'Experience When it Matters',
				'sr': 'Iskustvo kada je to važno'
			},
			content: {
	...
	intro: {
		...
		slogan: {
			...
			secondPart: {
				'en': 'Efficiency. Dedication.',
				'sr': 'Efikasnost. Posvećenost.'
			}
		}
	},
	team: {
